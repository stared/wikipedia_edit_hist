    ...
    var wikiApiInstance = {
        ...
        getRevs: function (query, dateFrom, dateTo, callback) {
            ...
            if (!!dateFrom && dateFrom.getFullYear) {
                wikiQueryParameters.rvend = [dateFrom.getFullYear(), ((dateFrom.getMonth() + 1)/100).toFixed(2).slice(2,4), (dateFrom.getDate()/100).toFixed(2).slice(2,4), "000000"].join("");
            }
            if (!!dateTo && dateFrom.getFullYear) {
                wikiQueryParameters.rvstart = [dateTo.getFullYear(), dateTo.getMonth() + 1, (dateTo.getDate()/100).toFixed(2).slice(2,4), "000000"].join("");
